...
export default function AdminCourses() {
    ...
    const CourseCard = ({ title, instructor, isLocked, hasDropdown }: any) => {
        ...
        return (
            <View style={styles.cardContainer}>
                <TouchableOpacity 
                    ...
                    onPress={() => hasDropdown && toggleExpand(title)}
                >
                ...
                {isExpanded && !isLocked && (
                    <View style={styles.dropdownContent}>
                        <TouchableOpacity style={styles.dropItem}>
                            <Ionicons name="beaker-outline" size={20} color="#2F459B" />
                            <Text style={styles.dropText}>Test your Knowledge</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={styles.dropItem}>
...
const styles = StyleSheet.create({
    ...
    progressBadge: { position: 'absolute', top: 10, left: 10, flexDirection: 'row', alignItems: 'center', backgroundColor: 'white', paddingHorizontal: 8, paddingVertical: 4, borderRadius: 12, borderWidth: 1, borderColor: '#DDD' },
    progressCircle: { width: 12, height: 12, borderRadius: 6, borderWidth: 2, borderColor: '#BDC3C7', marginRight: 5 },
    ...
    dropdownContent: { backgroundColor: "white", paddingHorizontal: 15, paddingBottom: 10, borderTopWidth: 1, borderTopColor: '#EEE' },
    dropItem: { flexDirection: "row", alignItems: "center", paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: "#F0F0F0" },
    dropText: { fontSize: 14, color: "black", marginLeft: 15, textDecorationLine: 'underline' },

...
export default function AdminEditPolicies() {
    ...
    const handleSave = () => {
        Alert.alert("Changes Saved", "The policies have been updated successfully.", [
            ...
            >
                <ScrollView contentContainerStyle={styles.scrollContent}>
                    <View style={styles.editorContainer}>
                        <Text style={styles.label}>Editing: {activeTab === 'Privacy' ? 'Privacy Policy' : 'Terms of Use'}</Text>
                        <TextInput
                            style={styles.textArea}
                            multiline
                            textAlignVertical="top"
                            value={activeTab === 'Privacy' ? privacyPolicy : termsOfUse}
                            onChangeText={activeTab === 'Privacy' ? setPrivacyPolicy : setTermsOfUse}

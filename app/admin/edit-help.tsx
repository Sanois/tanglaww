...
export default function AdminEditHelp() {
    ...
    const [faqs, setFaqs] = useState([
        { id: '1', q: "How to reset my password?", a: "Go to the login screen and click 'Forgot Password'." },
        { id: '2', q: "Where can I find review materials?", a: "Navigate to the Courses tab in your dashboard." }
    ]);
    ...
    const updateFaq = (id: string, field: 'q' | 'a', text: string) => {
        setFaqs(prev => prev.map(f => f.id === id ? { ...f, [field]: text } : f));
    };
                    ...
                    <ScrollView contentContainerStyle={styles.scrollContent}>
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(txt) => setContactInfo({...contactInfo, email: txt})}
                            />
                        </View>
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(txt) => setContactInfo({...contactInfo, phone: txt})}
                            />
                        </View>
                        <View style={styles.inputGroup}>
                            ...
                            <TextInput
                                ...
                                onChangeText={(txt) => setContactInfo({...contactInfo, office: txt})}
                            />
                        </View>
                    </ScrollView>
                )}
...
const styles = StyleSheet.create({
    ...
    tabContainer: { flexDirection: 'row', padding: 15, backgroundColor: '#F8F9FA' },
    ...
    inputLabel: { fontSize: 12, fontWeight: 'bold', color: '#2F459B', marginBottom: 5, marginTop: 5 },
    input: {

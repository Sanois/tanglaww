      ...
      <View style={styles.tabContainer}>
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "Tanglaw" && styles.activeTabText,
            ]}
          >
            Tanglaw
          </Text>
        ...
        >
          <Text
            style={[
              styles.tabText,
              activeTab === "TARC" && styles.activeTabText,
            ]}
          >
            TARC
          </Text>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              onChangeText={
                activeTab === "Tanglaw" ? setTanglawContent : setTarcContent
              }
          ...
          <View style={styles.infoBox}>
            ...
            <Text style={styles.infoText}>
              Changes made here will be reflected immediately in the student's
              "About" section.
            </Text>
          </View>
        </ScrollView>
